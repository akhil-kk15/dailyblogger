            ...
            <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
               <div class="carousel-inner">
                  <div class="carousel-item active">
                     <div class="container">
                        <h1 class="banner_taital">Show off Your acheivements</h1>
                        <p class="banner_text">Welcome to dailyBlogger, your blogging life starts here</p>
                        <div class="read_bt"><a href="#">Start Blogging</a></div>
                     </div>
                  </div>
