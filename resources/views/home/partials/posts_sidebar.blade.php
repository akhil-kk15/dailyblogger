    ...
    <div class="sidebar_widget stats_widget">
        ...
        <div class="widget_content">
            @php
                ...
                $recentPosts = \App\Models\Posts::where('post_status', 'active')
                    ->where('created_at', '>=', now()->subDays(7))
                    ->count();
            @endphp
            ...
            <div class="stats_grid">
                <div class="stat_item">
                    <div class="stat_number">{{ $totalPosts }}</div>
                    <div class="stat_label">Total Posts</div>
                </div>
                <div class="stat_item">
                    <div class="stat_number">{{ $totalUsers }}</div>
                    <div class="stat_label">Active Users</div>
                </div>
                <div class="stat_item">
                    <div class="stat_number">{{ $totalCategories }}</div>
                    <div class="stat_label">Categories</div>
                </div>
                <div class="stat_item">
                    <div class="stat_number">{{ $recentPosts }}</div>
